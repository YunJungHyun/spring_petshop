	...
	<div class="page-container">
		<div class="page-content mt-3">
			<div class="page-content_title">
				<span class="page-content_title_span">제품 기본 정보</span>
			</div>
			<div class="page-content_group">
				<div class="row">
					<div class="col-lg-6 page-content_group_box img-box" id="product-img-box">
						<img class="img-box_img" src="/resources/icon/none2.png" />
					</div>
					<div class="col-lg-6 page-content_group_box info-box">
						<div class="info-box_row">
								...
								<select  class="custom-select info-box_group_select input-chk" id="pccode">
									...
									<c:forEach items="${cList }" var ="clist">
										<c:if test="${clist.level == 2 }">
											<option value="${clist.ccoderef}-${clist.ccode}" style="display:none">
												${clist.cname}
											</option>
										</c:if>
									</c:forEach>
							...
							<div class="info-box_group ">
								...
								<input type="text" class="info-box_group_input input-chk" autocomplete='off' id="pbrand" placeholder="브랜드 이름을 입력하세요."> 
								<div class="invalid-feedback">
							...
							<div class="info-box_group "> 
								...
								<input type="text" class="info-box_group_input input-chk" autocomplete='off' id="pname" placeholder="제품 이름을 입력하세요."> 
								<div class="invalid-feedback">
							...
							<div class="info-box_group "> 
								...
								<input type="text" class="info-box_group_input input-chk" autocomplete='off' id="pprice" placeholder="가격을 입력해주세요." onkeyup="inputNumberFormat(this)"> 
								<div class="invalid-feedback">
							...
							<div class="info-box_group ">
								...
								<input type="text" class="info-box_group_input" autocomplete='off' id="pcnt" placeholder="입고량을 입력해주세요." onkeyup="inputNumberFormat(this)"> 
								
							</div>
							<div class="info-box_group "> 
								<label class="info-box_group_label" for="pname">할인율</label>
								<input type="text" class="info-box_group_input" autocomplete='off' id="psale" placeholder="할인율을 입력해주세요."> 
				...
				<div class="page-content_group">
					...
					<script>   
					 	var ckeditor_config = {
							...
							CKEDITOR.instances.pexplicate.setData('<h5><strong>제품 설명</strong></h5><p><br/><p><br/><p><br/><p><br/><h5><strong>제품 특징</strong></h5><p><br />');
					</script>
				</div>
			</div>
			...
			<div class="page-content mt-3 ">
				<div class="page-content_btn-group">
					<div class="page-content_btn-group_box col-6">
						<button type="button" class="btn btn-primary page-content_btn-group_button" id="product-insert-btn">제품 등록</button>
					</div>			
					<div class="page-content_btn-group_box col-6">
						<button type="button" class="btn btn-danger page-content_btn-group_button" id="product-insert-reset-btn">취소</button>
					</div>			
				</div>			
			</div>
	</div>
...
<script>
$("#product-insert-reset-btn").on("click",function(){
...
$("#product-insert-btn").on("click",function(){
	...
	if($("#pimg")[0].files[0] == undefined){
		
		$(".pimg-chk").children().css("display","block");
	}else{
		
		$(".pimg-chk").children().css("display","none");
		pimgFile =true;
	}
