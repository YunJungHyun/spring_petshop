	...
	<div class="container">
		...
		<div class="page-contents page-joinsort d-flex flex-column justify-content-center col-lg-4 ">
			...
			<div class="page-box"> 
				...
				<button class="joinsort-btn kakkao-join mb-1" id="api-signUp-kakao">
				...
				<button class="joinsort-btn naver-join mt-1 mb-1" id="api-signUp-naver">
				...
				<button class="joinsort-btn petshop-join mt-1 d-flex justify-content-center">
...
$('.carousel').carousel({
	...
	$(".petshop-join").on("click",function(){
		
		location.href="/view/user/join"
	})
