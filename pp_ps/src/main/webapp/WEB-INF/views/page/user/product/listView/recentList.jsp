...
<div class="page">
	<div class="page-container">
		<div class="page-content page-content-title mt-3">
			<span class="page-content-title_span">신규 제품</span>
		</div>
			...
			<div class="swiper category-swiper">
				<div class="swiper-wrapper category-swiper_wrapper">
					...
					<c:if test="${list.level==1 }">
						<div class="swiper-slide category-swiper_wrapper_slide">
							<a href="/product/view/recent?categoryCode=${list.ccode }">
								<span class="slide-span" id="slide-span-${list.ccode }">${list.cname}</span>
							</a>
						</div>
					</c:if>
					</c:forEach> 
